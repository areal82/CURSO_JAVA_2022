package com.atsistemas.formacion.base.spring.examplewebapp.repository.impl;
...
public class PeliculasRepositoryImpl implements PeliculasRepository {
	...
	public PeliculasRepositoryImpl() {
	...
	public List<Pelicula> listarPeliculas() {
		...
		resultado.add(peliculas.get(1));
		resultado.add(peliculas.get(2));
		return resultado;
	}
